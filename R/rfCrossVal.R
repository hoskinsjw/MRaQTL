...
#'   \item  A png file of the phenotype distributions for the training and test
#'   sets.
#'   \item  A png file of the random forest cross-validation plot depicting the
#'   mean cross-validation error as a function of the number of regulators
#'   used as predictors of the phenotype of interest. Error bars represent the
#'   standard deviation across all replicates, which by default is set to 12.
#'   \item  An .RData workspace image file containing all environment variables
#'   from this analysis, which should be used as an input for the final MR
#'   analysis with the finalRF() function.
#'   }
#' @export
#'
#' @examples
